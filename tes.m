...
% Last Modified by GUIDE v2.5 03-May-2019 16:34:14
...
audioInfo = audioinfo(handles.fullpathname);

display(audioInfo);


set(handles.filename, 'String', audioInfo.Filename);
set(handles.artistname, 'String', audioInfo.Artist);
set(handles.audioTitle, 'String', audioInfo.Title);
set(handles.compressionMethod, 'String', audioInfo.CompressionMethod);
set(handles.numberOfChannels, 'String', audioInfo.NumChannels);
set(handles.sampleRate, 'String', audioInfo.SampleRate);
set(handles.totalSamples, 'String', audioInfo.TotalSamples);
set(handles.duration, 'String', audioInfo.Duration);
set(handles.bitsPerSample, 'String', audioInfo.BitsPerSample);
...
orde= str2double(handles.order.String);
...
%player = audioplayer(handles.Volume*handles.yT, handles.Fs * 0.5);

sound(handles.Volume*handles.yT, handles.Fs * str2double(handles.fsMultiple.String));
...
%Writing filtered audio signal to file.
audiowrite('assets/filteredAudioFile1.wav', handles.yT, handles.Fs * str2double(handles.fsMultiple.String));
...
function fsMultiple_Callback(hObject, eventdata, handles)
% hObject    handle to fsMultiple (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of fsMultiple as text
%        str2double(get(hObject,'String')) returns contents of fsMultiple as a double


% --- Executes during object creation, after setting all properties.
function fsMultiple_CreateFcn(hObject, eventdata, handles)
% hObject    handle to fsMultiple (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
